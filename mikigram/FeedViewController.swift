...
class FeedViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, MessageInputBarDelegate {
    ...
    //dismiss the keyboard by dragging down the tableview
 ...
 //every post should have an array called comments
        ...
        showsCommentBar = false
        becomeFirstResponder()
   // commentBar.inputTextView.canResignFirstResponder
    }
    
    //list those two cell
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        let post = posts[section]
        //now grab the comments
        //an array of PFObjects
        //in parentheses means it's optiona
    ...
    //how do you tell what kind of cell to return
